...
class Affiliate_Links_Pro_Recent_Links extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __( 'The most recent affiliate links on your site', 'affiliate-links' ),
		);

		$this->stat_instance = Affiliate_Links_Pro_Stats::get_instance();

		parent::__construct( 'affiliate-links-recent', __( 'Recent Affiliate Links', 'affiliate-links' ), $widget_ops );
	...
	public function widget( $args, $instance ) {
		...
		$title = apply_filters( 'widget_title', empty( $instance['title'] ) ? __( 'Recent Links', 'affiliate-links' ) : $instance['title'], $instance, $this->id_base );
